...
class WorkExperienceModel(models.Model):
    ...
    def __str__(self):
        return self.user.name + " worked as " + self.job_title
...
class EducationModel(models.Model):
    ...
    def __str__(self):
        return self.user.name + " achieved " + self.degree
...
class SkillSetModel(models.Model):
    ...
    def __str__(self):
        return self.user.name + " can do " + self.skill_title
...
class ReferenceModel(models.Model):
    ...
    def __str__(self):
        return self.name + " referenced " + self.user.name
...
class LanguageModel(models.Model):
    ...
    def __str__(self):
        return self.user.name + " speaks " + self.language
...
class AwardModel(models.Model):
    ...
    def __str__(self):
        return self.user.name + " was awarded " + self.detail
